...
fn post_accumulator_attestation(
    ...
    let mut sequence: AccumulatorSequenceTracker = {
        let data = bank
            ...
            .unwrap_or_default();
        let data = data.data();
        // It is non-trivial to update to borsh 1.0, as the `BorshSerialize` and `BorshDeserialize`
        // instances are defined in the `pythnet_sdk` crate.  I would need to fork it and update
        // there.
        #[allow(deprecated)]
        borsh0_9::try_from_slice_unchecked(data)
    ...
    sequence.sequence += 1;
    let sequence = solana_sdk::borsh0_9::BorshSerialize::try_to_vec(&sequence)
    ...
    let message = solana_sdk::borsh0_9::BorshSerialize::try_to_vec(&message)
...
pub fn compute_publisher_stake_caps(
    ...
    let parameters: StakeCapParameters = {
        ...
        // there.
        #[allow(deprecated)]
        borsh0_9::try_from_slice_unchecked(data).unwrap_or_default()
    };
