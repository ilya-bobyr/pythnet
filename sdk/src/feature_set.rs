...
pub mod curve25519_syscall_enabled {
    solana_sdk::declare_id!("5uBjdvsRctU6F4T2GRznJUiX9JaNCpphmCf3dDCFTjad");
}
...
pub mod libsecp256k1_fail_on_bad_count2 {
    solana_sdk::declare_id!("PsFgPa9cuHk3fkQWUEjp4SNe1DuCmvwiGSPF4TzuygE");
}
...
pub mod credits_auto_rewind {
    solana_sdk::declare_id!("7ZwjmWo3U4DPisqDxJmRv78jVfBKrrFtzVYRMSi2k3J4");
}
...
pub mod bank_transaction_count_fix {
    solana_sdk::declare_id!("AWkcxcfEcowjSdANnDrvENeg6mPPG4VXJhe1AVJb87n9");
}
...
pub mod check_slice_translation_size {
    solana_sdk::declare_id!("6obsKRRCLEaqduRyB2ncXpg24wyH6zJBkpiLxbNuWaNx");
}

pub mod stake_split_uses_rent_sysvar {
    solana_sdk::declare_id!("HVyEmYP7qrWbfNBkkor2eEf2LeTrmukP4rF4embr8vKA");
}
...
pub mod error_on_syscall_bpf_function_hash_collisions {
    solana_sdk::declare_id!("7eHZKXr3qRKfVh5V3aBvhCr9fEGgza7BuwGfVZBtbrqc");
}

pub mod reject_callx_r10 {
    solana_sdk::declare_id!("AxJiyQ64KiNVrGHDcppSZhUSdD6xM7YXkLBUk5UinABL");
}
...
pub mod fix_recent_blockhashes {
    solana_sdk::declare_id!("CdBuhJNFkr9dMjCFirEuLBMWUW9WfpV7vpSBNeMjxiup");
}

pub mod update_rewards_from_cached_accounts {
    solana_sdk::declare_id!("G8VCBZHxL7hj5ftgai2xmzH7R3xTK5DAphZ5vt1Tfs8E");
}
...
pub mod disable_deploy_of_alloc_free_syscall {
    solana_sdk::declare_id!("B9JC8nsGUKWk2uVooadsG4NWyepfmgsUHDng2W633fQE");
}
...
pub mod vote_state_update_credit_per_dequeue {
    solana_sdk::declare_id!("3oDJkmrh6Nc7FoDtqjzZUCvgHob8CQh179Eu7o7AZfgh");
}
...
pub mod enable_bpf_loader_extend_program_ix {
    solana_sdk::declare_id!("5iXqxFKyiMUWrcnpGuybTwxabfvKcHfazCWeMmKZnnfH");
}

pub mod enable_early_verification_of_account_modifications {
    solana_sdk::declare_id!("x8oiZz3CqRG2DjEaufVVVgBhKpsyH1MR4ygwkYe362S");
}

pub mod skip_rent_rewrites {
    solana_sdk::declare_id!("HGiEiy8r54LmqrdksquLQDLswGy5hZruGo6xyBZuU8us");
}
...
pub mod cap_bpf_program_instruction_accounts {
    solana_sdk::declare_id!("2ecRV4oLAseMiNVVhQARvRXByn4rEUt9piqjPeSqWD7i");
}

pub mod loosen_cpi_size_restriction {
    solana_sdk::declare_id!("Hu9maMqkhBR8CwEatspmCobqabCGkvhLvD6qrozNxVby");
}

pub mod use_default_units_in_fee_calculation {
    solana_sdk::declare_id!("4ND9Kw2UMnnYqYzXJ4pYAPmjrKCFcbBwSFbG73HQBvyP");
}

pub mod compact_vote_state_updates {
    solana_sdk::declare_id!("GbQgfb83eYXkG7SFWWKboeaXmZfGamKph8NhQdKvpfag");
}

pub mod incremental_snapshot_only_incremental_hash_calculation {
    solana_sdk::declare_id!("BHfAJREMZKkJemntkzEdLE53AsSvqBiiWQXsPGgLtnWu");
}

pub mod disable_cpi_setting_executable_and_rent_epoch {
    solana_sdk::declare_id!("8X2nmyNke9j8hbcoKA3ojif2UqZMyDiAJ3pbY8QxNarV");
}

pub mod on_load_preserve_rent_epoch_for_rent_exempt_accounts {
    solana_sdk::declare_id!("6fxJAdXou2qcVm92NeqQA6kEHRn9o8M7sWPndnLy8En1");
}

pub mod account_hash_ignore_slot {
    solana_sdk::declare_id!("GhKciAAVxjp1YtCmc4beJDcGR2sRs622jMPZGe8QwB74");
}

pub mod set_exempt_rent_epoch_max {
    solana_sdk::declare_id!("8Zs2sp2oejPLvS77BwwXdFnSodLffWFpYuZmGfLJnYfg");
}

pub mod relax_authority_signer_check_for_lookup_table_creation {
    solana_sdk::declare_id!("BaFBbimszJFQdQpuWT9K1wJgb5oeqecHgTjsbneLLvPv");
}

pub mod stop_sibling_instruction_search_at_parent {
    solana_sdk::declare_id!("5h9ZGep87YUacY5FuDoJVtHvKkQb2XoWfiTfJ3szSsbi");
}

pub mod vote_state_update_root_fix {
    solana_sdk::declare_id!("FxkQvT49HqDViqpoZqPnDbG26XGsHwpz96xajWotB1u3");
}

pub mod cap_accounts_data_allocations_per_transaction {
    solana_sdk::declare_id!("A45rAHbSpLKbvbuQdBkHjHNZN8YcVztBz5BSVjSCFonZ");
}

pub mod epoch_accounts_hash {
    solana_sdk::declare_id!("5J325GXhpVsg8Tcw2piPn7FwL6tMj76qhMUU3VxKAN4j");
}

pub mod remove_deprecated_request_unit_ix {
    solana_sdk::declare_id!("ArQLLPJtfcCPdu21YyMG3RL61docpk37zjLrpYWWrE4K");
}

pub mod disable_rehash_for_rent_epoch {
    solana_sdk::declare_id!("APrMcwgCnNw8zwfE2seS1r1qheL5MHjWruwL5tkiCyMQ");
}
...
pub mod limit_max_instruction_trace_length {
    solana_sdk::declare_id!("H4cCtuwEWDG7xDRsZwwyhMcLcsYtUyqQRRSWFWbh7su5");
}
...
pub mod enable_bpf_loader_set_authority_checked_ix {
    solana_sdk::declare_id!("7B1dpPyDPNvg59xYTLnHD5e1SgYFWXgMufowt2nRnSye");
}
...
pub mod enable_program_redeployment_cooldown {
    solana_sdk::declare_id!("76DaiWXGtAymEdeRVp433JuRXtsvr9pynPxpHcLHGEJE");
}

pub mod commission_updates_only_allowed_in_first_half_of_epoch {
    solana_sdk::declare_id!("6qfJQ4HCWjP17Nry29WGJzkCDq3z53MPUpWMHwQUPwUh");
}

pub mod enable_turbine_fanout_experiments {
    solana_sdk::declare_id!("AXx1rVVpixNPFhTRABGrtUf5xPhic5gT3rombZCk67u9");
}
...
pub mod update_hashes_per_tick {
    solana_sdk::declare_id!("6atiKNtJxYqdU2BsKk7qWfAcdZEfFYbZZBi4hQo62nRD");
}
...
pub mod disable_builtin_loader_ownership_chains {
    solana_sdk::declare_id!("7ar7MbQaDLPhprub9QbzqwB9uZ3NCA8m4Jf3WPC8ejB5");
}

pub mod cap_transaction_accounts_data_size {
    solana_sdk::declare_id!("7SMtLdMkMGY8uxRvBmkPgp9yTWEXKHLk8PejZsohv1Zp");
}

pub mod remove_congestion_multiplier_from_fee_calculation {
    solana_sdk::declare_id!("BDYfK7v9BufVpAQqzWsU1CHYF5UHEv8zX8KtRe1Qamvh");
}

pub mod enable_request_heap_frame_ix {
    solana_sdk::declare_id!("7RjMQ2nxr2pfXSbvka1uHFURtGHfiALXACUBCUGfTR4A");
}

pub mod prevent_rent_paying_rent_recipients {
    solana_sdk::declare_id!("DNypToW9FjbMwgjcGY8V6DPmmEu3rxUjfKpFy4SrisSr");
}

pub mod delay_visibility_of_program_deployment {
    solana_sdk::declare_id!("ARUqVPGu7TFbXj4y9ZTdritEv3fgmRsWTMKZ1TJpvrsR");
}

pub mod apply_cost_tracker_during_replay {
    solana_sdk::declare_id!("k9pepttAX5HNACoP3jDR4ChjKzCWe3Kmzw6CKWXSqKe");
}
...
pub mod add_set_tx_loaded_accounts_data_size_instruction {
    solana_sdk::declare_id!("2o4fq5MHW1rQJHp1SoRc4PdgeTKiXfL7x3UG6LRwiRqa");
}

pub mod switch_to_new_elf_parser {
    solana_sdk::declare_id!("78aoacz95Nsqo57LfA2gTMmG3tK9GFFMCR2wec7TLa4n");
}

pub mod round_up_heap_size {
    solana_sdk::declare_id!("2MdEcKzS26Swa93cnRyW13zRv7uuAHJ1fkHgfRZ6cckC");
}

pub mod remove_bpf_loader_incorrect_program_id {
    solana_sdk::declare_id!("2KesFs9k3kiNRtQdD9FSyEKoBWLtWB5XWUdipyxKXUSF");
}
...
pub mod native_programs_consume_cu {
    solana_sdk::declare_id!("Ap1hqFSpT3Td2wRHiY1odmWcpVtACLjTEfESN2SVvzFi");
}

pub mod simplify_writable_program_account_check {
    solana_sdk::declare_id!("AdhcWEbi4554eH21GvCQS2EeDKDiKBMdeHzxu9eKzmZZ");
}

pub mod stop_truncating_strings_in_syscalls {
    solana_sdk::declare_id!("E5VxK9RrK1Y6wHC4FYzGRTN5pbpYdGcRQ3jTheUXQrkx");
}

pub mod clean_up_delegation_errors {
    solana_sdk::declare_id!("7qUqAR4xZFQhN3ZfWhMfcpU8RjoTyWSHJHUtVmi3qJJL");
}

pub mod vote_state_add_vote_latency {
    solana_sdk::declare_id!("AwECxaeYjxVSMMiHeMCxtpp7W9J1mkDTfs38fQyiY1vE");
}

pub mod checked_arithmetic_in_fee_validation {
    solana_sdk::declare_id!("EZpcW2eVj1AR4ekMLybg72jkkmEQYeo9BKEmjueZBQ4w");
}
...
pub mod reduce_stake_warmup_cooldown {
    solana_sdk::declare_id!("CjQbfuz3kUkKQCJxqLzM6GWVwd7411mKNivvCJZSMTeW");
}

pub mod revise_turbine_epoch_stakes {
    solana_sdk::declare_id!("ArXMrSasktHcQZAxPeYUzN1FWVRjFbyBjnEDF9wy6ayc");
}
...
pub mod require_rent_exempt_split_destination {
    solana_sdk::declare_id!("46tGnNS4Z9t5X6P6QXWbT5K3HNJtVqdAXw242jGsDpXC");
}
