...
fn process_account_indexes(matches: &ArgMatches) -> AccountSecondaryIndexes {
    ...
    {
        panic!(
            "The oracle program id and message buffer program id must be included in the account \
             index. Add the following flags:\n\
    ...
    {
        panic!(
            "The oracle program id and message buffer program id must *not* be excluded from the \
             account index."
        );
    }
